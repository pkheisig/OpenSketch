/* eslint-disable react-refresh/only-export-components -- library entry intentionally exports its host-facing factory and component. */

import "../styles/app.css";

// Keep the document-font contract identical to the standalone PWA. The module
// entry owns the CSS import, while the host continues to own ReactDOM and page
// mounting.
