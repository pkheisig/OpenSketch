...
OpenSketch bundles the following open font software locally so figures and the
editor do not depend on a runtime font service:

- Inter — Copyright 2016 The Inter Project Authors.
- Source Sans 3 — attributed by the distribution to Google Inc.
